...
public class DynamicBeat extends JFrame {
	...
	private Image selectedImage = new ImageIcon(Main.class.getResource("../image/BlueMainImage.jpg")).getImage();
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../image/Blue TitleImage.png")).getImage();
